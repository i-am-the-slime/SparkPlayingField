...
import org.menthal.model.events.{CCSmsReceived, MenthalEvent}
...
//
//  def toSomeMap[A:Semigroup](events: RDD[MenthalEvent]): UserBucketsRDD[Map[String, A]] = {
//    val buckets = events.map {
//      case e: MenthalEvent match {
